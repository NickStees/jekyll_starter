...
gulp.task('watch', function () {
  ...
  gulp.watch(['assets/js/**/*.js','!assets/js/**/*.min.js','!assets/js/bundle.js'], ['bundle-js']);
...
gulp.task('images', function() {
    gulp.src(['assets/_src_img/**/*.png','assets/_src_img/**/*.jpg','assets/_src_img/**/*.gif','assets/_src_img/**/*.jpeg','assets/_src_img/**/*.svg']).pipe(imagemin({
      interlaced: true,
      progressive: true,
      optimizationLevel: 5,
